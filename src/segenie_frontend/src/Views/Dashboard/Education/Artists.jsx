...
const Artists = ({setClaim, setColor, provider, canClaim}) => {
    ...
    <article key={'create'} className={classnames(styles. portfolio__item)}>
       <div className="relative rounded-full bg-[#3bc4f6] py-1 px-2 text-center">New</div>
        <div className={classnames(styles. portfolio__item_image2)}>
              <img className="rounded-t-lg" src='./nft_collection/biology.png' alt={'title'} />
          </div>
          <div>
          <h3 className="pt-3">High School</h3>
          <h3 className="text-xl text-[#3b82f6]">Biology</h3>
          <h3>99</h3>
