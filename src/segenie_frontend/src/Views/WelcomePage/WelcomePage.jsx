  ...
  return (
    <>
      <main className="welcome">
            ...
            <h1 className={`pb-6 text-[#e6e6e6] text-3xl font-bold flex justify-center font-raleway`}>Welcome to Segenie</h1>
              <div className="flex pt-10 space-x-20">
                ...
                <div className="flex flex-col ">  
                  ...
                  <a className="mt-8 text-[#e6e6e6] flex justify-center font-raleway cursor-pointer" 
                    onClick={portal}>Create a New Portal
                  </a>
                </div>
                ...
                <div className="flex flex-col ">  
                  ...
                  <a className="mt-8 text-[#e6e6e6] flex justify-center font-raleway cursor-pointer" 
                    onClick={options}>Explore the Metaverse
                  </a>
                </div>
