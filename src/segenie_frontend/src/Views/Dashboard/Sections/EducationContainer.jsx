...
import Banner from "../../../../assets/nft_collection/ed.png";
...
import Artists from '../Education/Artists'
import Tiktok from '../Education/Tiktok'
import Europe from '../Education/Europe'
import Asia from '../Education/Asia'
import Genres from '../Education/Genres'
      ...
      <div className={classnames(styles.left)}>
        ...
        >
          <div className={classnames(styles.textContainer)}>
            <h1>Education</h1>
            <h2 className="-mt-2 mb-6">Diploma NFTs</h2>
