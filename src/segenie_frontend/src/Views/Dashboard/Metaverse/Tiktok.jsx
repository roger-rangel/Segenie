...
const Tiktok = ({setClaim, setColor, provider, canClaim}) => {
    ...
    <article key={'create'} className={classnames(styles. portfolio__item)}>
       <div className="relative rounded-full bg-[#3b82f6] py-1 px-2 text-center">New</div>
        <div className={classnames(styles. portfolio__item_image2)}>
              <img className="rounded-t-lg" src='./nft_collection/motorcycle.jpeg' alt={'title'} />
          </div>
          <div>
          <h3 className="pt-3">Vehicles</h3>
          <h3 className="text-xl text-[#3b82f6]">Motorcycles</h3>
          <h3>660</h3>
