...
const Genre = ({setClaim, setColor, provider, canClaim}) => {
    ...
    <article key={'create'} className={classnames(styles. portfolio__item)}>
       <div className="relative rounded-full bg-[#3b82f6] py-1 px-2 text-center">New</div>
        <div className={classnames(styles. portfolio__item_image2)}>
              <img className="rounded-t-lg" src='./nft_collection/learn_playing.jpeg' alt={'title'} />
          </div>
          <div>
          <h3 className="pt-3">Tech 4 Kids</h3>
          <h3 className="text-xl text-[#3b82f6]">E-Play</h3>
          <h3>729</h3>
