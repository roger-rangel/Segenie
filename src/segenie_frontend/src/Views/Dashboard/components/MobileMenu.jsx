    ...
    <div class="container flex flex-wrap items-center justify-between mx-auto">
      <div className="flex items-center">
        <a href="https://flowbite.com/" class="flex items-center">
            <img src="/icons/logo2.svg" class="h-8 mr-3 sm:h-12" alt="Flowbite Logo" />
            <span class="self-center text-xl font-semibold whitespace-nowrap dark:text-white">Segenie</span>
            
        </a>
        <div className="flex rounded-full bg-[#ff006e] h-6 px-3 ml-4 items-center">Demo Mode</div>
      </div>
